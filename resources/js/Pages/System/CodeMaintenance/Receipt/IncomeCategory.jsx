...
const IncomeCategory = ({ activeTab, setActiveTab }) => {
  const { setting_data, banks, income_categories, most_recently_changed } = usePage().props
  ...
  return (
    <Box>
      ...
      >
        <Box sx={defaultModalStyles}>
          <Typography variant="h6" component="h2">
            {editMode ? 'Kemaskini' : 'Tambah'} Kategori Hasil
          </Typography>
          <Typography sx={{ mt: 2 }}>
            <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 2 }}>
              <Typography sx={{ width: 300 }}>Kod Kategori Hasil</Typography>
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
              <Typography sx={{ width: 300 }}>Kategori Hasil</Typography>
              <Typography>:</Typography>
              <Box>
                <FormControl>
                  <TextField
      ...
      <BoxPaddingX>
        <TitleCaptions title="Kategori Hasil" extraStyles={{ my: 2 }} />
        <Stack direction="row" spacing={2}>
          <FormControl fullWidth size="small">
            <InputLabel>Kod Kategori Hasil</InputLabel>
            <Select
              value={activeTab.code || ''}
              label="Kod Kategori Hasil"
