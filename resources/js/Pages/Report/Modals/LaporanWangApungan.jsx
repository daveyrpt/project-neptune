...
export default function LaporanWangApungan({
    data,
    open,
    handleCloseModal,
    setData,
    ...
    const { cashiers, collection_centers } = usePage().props
        ...
        >
            <Box sx={{
                ...
                <Box sx={{ display: 'grid', gap: 2, mt: 2 }}>
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                        <Typography sx={{ width: 150 }}>Jenis</Typography>
                        <Typography>:</Typography>
                        <Box>
                            <FormControl>
                                <TextField
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                        <Typography sx={{ width: 150 }}>Tarikh</Typography>
                        <Typography>:</Typography>
                        <Box>
                            <FormControl>
                                <DateField
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                        <Typography sx={{ width: 150 }}>Jumlah (RM)</Typography>
                        <Typography>:</Typography>
                        <Box>
                            <FormControl>
                                <TextField
