...
class PushRecordFromPLMISToLegacy extends Command
{
    ...
    */
     ...
     * @var string
     */
    protected $signature = 'sync-receipt:step-1';
    ...
    public function handle()
    {
        ...
        try {
            foreach ($tables as $remoteTable => $localTable) {
                ...
                $folderPath = storage_path("app/mysql_db/sync/receipts");
                ...
                $this->info("✅ [$remoteTable] exported to: storage/app/mysql_db/sync/receipts/{$filename}");
